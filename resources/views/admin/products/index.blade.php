                    ...
                    <div class="form-control">
                        ...
                        @csrf
                            <div class="input-group">
                                <input type="text" placeholder="Search…" name="search" class="input input-bordered w-full" value="{{ request('search') }}" />
                                <button type="text" class="btn px-6 bg-secondary border-none hover:bg-primary">
        ...
        <x-container>
            <div class="flex flex-wrap">
                <div class="w-full px-4">
                    <a href="{{ route('admin.products.create') }}" class="btn btn-success text-white mb-3">Tambah Produk</a>
                        ...
                        <tbody>
                            @forelse ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('storage/' . $product->image) }}" alt="" class="w-24 rounded-md">
                                    </td>
                                    <td>{{ $product->name }}</td>
